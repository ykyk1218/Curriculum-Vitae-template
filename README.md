...
| 種類          | 年数 | レベル感                                                     |
| ------------- | ---- | ------------------------------------------------------------ |
| Ruby on Rails | 5年以上  | 適切なModel設計<br />役割に応じたクラス設計<br />deviseやauthlogicを使ったログイン処理<br />carrierwaveを使った画像アップロード処理<br />キャッシュの利用やActiveRecordの最適化などでのパフォーマンス改善<br />Rspecを利用したテストコード<br /><br />などができます |
